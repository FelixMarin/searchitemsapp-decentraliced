...
INSERT INTO sia.tb_sia_selectores_css (did, did_empresa, did_url, bol_activo, fec_modificacion, scrap_pattern, scrap_no_pattern, sel_image, sel_producto, sel_precio, sel_pre_kilo, sel_link_prod, sel_paginacion) VALUES (108, 107, 104, true, '2019-07-18', 'div.product-item', NULL, 'a.product-image img|src', 'div:nth-of-type(n) [role] a', 'div:nth-of-type(n) span.price-offer-now', 'div:nth-of-type(n) span.price-product', '.show|href', NULL);
...
INSERT INTO sia.tb_sia_selectores_css (did, did_empresa, did_url, bol_activo, fec_modificacion, scrap_pattern, scrap_no_pattern, sel_image, sel_producto, sel_precio, sel_pre_kilo, sel_link_prod, sel_paginacion) VALUES (101, 101, 113, true, '2019-07-18', 'hits', NULL, 'thumbnail', 'display_name > value', 'unit_price', 'reference_price', 'share_url', NULL);
...
INSERT INTO sia.tb_sia_selectores_css (did, did_empresa, did_url, bol_activo, fec_modificacion, scrap_pattern, scrap_no_pattern, sel_image, sel_producto, sel_precio, sel_pre_kilo, sel_link_prod, sel_paginacion) VALUES (109, 108, 107, true, '2019-07-18', 'div.caja', NULL, '.cut-alt-img img|src', 'div:nth-of-type(n) .productName span', '.priceContainer span.price', '.priceContainer > span.price > span.pesoVariable', 'div > h2 > a[href]|href', 'ul.pagination > li > a|href');
