...
public class ScrapingHipercor implements IFScrapingEmpresas {
	...
	public List<String> getListaUrls(final Document document, 
		...
		int numresultados = StringUtils.desformatearEntero(CommonsPorperties.getValue("flow.value.paginacion.url.hipercor"));
