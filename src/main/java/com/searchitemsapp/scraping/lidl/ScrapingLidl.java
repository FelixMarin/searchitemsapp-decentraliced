 ...
 *
 */
public class ScrapingLidl extends AbstractScrapingEmpresas implements IFScrapingEmpresas {

	private static final Logger LOGGER = LoggerFactory.getLogger(ScrapingLidl.class);  
